...
"color: white;")
        ...
        self.testBtn = QtWidgets.QPushButton(self.page_3)
        self.testBtn.setGeometry(QtCore.QRect(234, 240, 191, 91))
        self.testBtn.setObjectName("testBtn")
        self.checkBtn = QtWidgets.QPushButton(self.page_3)
        self.checkBtn.setGeometry(QtCore.QRect(540, 270, 161, 81))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.testBtn.setText(_translate("MainWindow", "打开视频窗口"))
        self.checkBtn.setText(_translate("MainWindow", "检 查"))
