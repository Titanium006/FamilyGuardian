...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/home/icon/square.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/home/icon/split.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/home/icon/刷新_refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnLoadData.setIcon(icon2)
...
"#zoomBtn:pressed{background-color: rgb(189, 189, 189);}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/home/icon/pause-one.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap(":/home/icon/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/home/icon/右1_right-one.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.zoomBtn.setIcon(icon4)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/home/icon/search.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.queryButton.setIcon(icon5)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/home/icon/添加用户_add-user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.userAddBtn.setIcon(icon6)
